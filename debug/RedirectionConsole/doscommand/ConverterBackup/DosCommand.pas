...
begin //FExecute
  ...
  begin
    ...
    raise FCreateProcessError;  //  謔ﾉ raise してはならないB
    Exit;
  end;
 ...
 validates the wShowWindow member.}
  ...
  try /// handles of process
    ...
    repeat //main program loop
            //  ｶきていれば STILL_ACTIVE 死んでいればI了コ[ドがただちに返るB
            //  死んでいてもパイプのデ[タは有効B
...
//------------------------------------------------------------------------------
    ...
    //
    //  AOwner:TDosCommand を一つだけ受け取ったほうがよいB
    //  
...
begin
  ...
  inherited Create(False);  //  ただちに実sB
end;
...
//------------------------------------------------------------------------------
    ...
    //
    //  WaitFor ではeスレッドが止まってしまうH
    //  
    //  Apollo では起動中に[ｘ]でI了してもAmainloop をI了しないB
    //  
    //
