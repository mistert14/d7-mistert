...
{ ----------------------------------------------------------------------------
  ...
  ---------------------------------------------------------------------------- }
procedure Tunitfrmenumdemo.Timer1Timer(Sender: TObject);
var
  t: tftdichip;
  i: longint;
  s: string;
...
{ ----------------------------------------------------------------------------
  Fill list on start
  ---------------------------------------------------------------------------- }
procedure Tunitfrmenumdemo.FormShow(Sender: TObject);
begin
...
{ ----------------------------------------------------------------------------
  Double click event
  ---------------------------------------------------------------------------- }
procedure Tunitfrmenumdemo.ListBoxDblClick(Sender: TObject);
var
  s: string;
